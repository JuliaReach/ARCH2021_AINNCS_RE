...
print(Main.io, "JuliaReach, Double-Pendulum, less robust, falsified, $(res.time * 1e9)\n")

res = @timed run(false);
res_false = res.value

print(Main.io, "JuliaReach, Double-Pendulum, more robust, falsified, $(res.time * 1e9)\n")
